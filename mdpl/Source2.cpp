...
//	string rm;
//};
//Mem_t memt[memt_size] = { {false, true, true, false, "01", "110"}, {true, false, false,
//false, "00", "111"},
//{true, false, true, false, "01", "111"}, {false, true, true,
//true, "10", "110"}, {true, false, true, true, "10", "111"} };
...
//	{
//		if (memt[i].bp == bp[m] && memt[i].bx == bx[m] && memt[i].disp_l == disp_l
//			&& memt[i].disp_h == disp_h)
//		{
//			op->mod = memt[i].mod;
//			op->rm = memt[i].rm;
//		}
...
//		}
//		cout << command << endl;
//		command = op.opcode + to_string(op.d) + to_string(op.w) + op.mod + op.reg +
//			op.rm;
//		if (disp_l && disp_h)
