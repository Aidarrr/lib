...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<String[]> trainData = preprocess.parseInputFile(new File("Data/trainData.txt"));
        ArrayList<String[]> testData = preprocess.parseInputFile(new File("Data/testData.txt"));
