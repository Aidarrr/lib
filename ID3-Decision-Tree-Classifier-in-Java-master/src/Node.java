...
public class Node {
    ...
    int numOfClass2;
    double entropy;
    String[] attributesNames = {"Погода", "Температура", "Влажность", "Ветер", "Играть в теннис?"};
    ...
    public String toString() {
        String classString = "Yes";
        if (classification == 1) {
            classString = "Да";
        } else {
            classString = "Нет";
        }
        return isLeaf ? "Лист, class = " + classString : "Свойство = " + attributesNames[attribute];
    }
